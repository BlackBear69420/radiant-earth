        ...
        <section className="grid gap-10 lg:grid-cols-[1.05fr_1fr] lg:items-center">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-3 py-1 text-xs font-medium text-muted-foreground">
              <Leaf className="h-3.5 w-3.5 text-leaf" aria-hidden="true" /> Private, on-device, no
              sign-up
            </span>
            ...
            <p className="mt-5 max-w-xl text-base text-muted-foreground sm:text-lg">
              MyCarbon estimates your monthly carbon footprint from a few everyday inputs and turns
              the numbers into clear, doable next steps.
            </p>
